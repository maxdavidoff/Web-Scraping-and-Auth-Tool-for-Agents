...
DEFAULT_STATE_FILE = AUTH_DIR / "affordablehousing_state.json"
DEFAULT_SELECTORS_FILE = PROJECT_ROOT / "selectors.affordablehousing.json"
...
def get_settings(
    ...
    return Settings(
        start_url=start_url
        or os.getenv("AFFORDABLEHOUSING_START_URL", "https://www.affordablehousing.com/"),
        search_url=search_url
        or os.getenv("AFFORDABLEHOUSING_SEARCH_URL", "https://www.affordablehousing.com/"),
        location=location or os.getenv("AFFORDABLEHOUSING_LOCATION", "Boston, MA"),
