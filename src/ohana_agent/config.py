...
DEFAULT_STATE_FILE = AUTH_DIR / "ohana_state.json"
DEFAULT_SELECTORS_FILE = PROJECT_ROOT / "selectors.example.json"
...
def get_settings(
    ...
    return Settings(
        start_url=start_url or os.getenv("OHANA_START_URL", "https://liveohana.ai/"),
        search_url=search_url or os.getenv("OHANA_SEARCH_URL", "https://liveohana.ai/"),
        location=location or os.getenv("OHANA_LOCATION", "Philadelphia"),
